<template>
  <div>
    ...
    <b-navbar toggleable="lg" type="dark" variant="primary">
      <ul class="navbar-nav">
        <li class="nav-item">
          <router-link to="/" class="nav-item nav-link"><div id="logo"><img src="../assets/De-gudde-wellen-web.png" /></div></router-link>
        </li>
      </ul>
      ...
      <b-collapse id="nav-collapse" is-nav>
        <ul class="navbar-nav">
          <li class="nav-item">
            <router-link to="/menu" class="nav-item nav-link"><div class="extra-padding">Menu</div></router-link>
          </li>
          <li class="nav-item">
            <router-link to="/barman" class="nav-item nav-link"><div class="extra-padding">Barman</div></router-link>
          </li>
          <li class="nav-item">
