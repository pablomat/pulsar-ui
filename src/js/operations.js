 ...
 */
const owner_set_properties = {
  authorities: ['active'],
  description:
`
Example for props:
{"vesting_withdraw_intervals": 13,"vesting_withdraw_interval_seconds":604800,"vesting_withdraw_enable_vote":true}
`,
  params: {
    owner: account,
    props: owner_props
...
operations.sbd_create.name = 'Create EUR'
operations.sbd_burn.name = 'Burn EUR'
